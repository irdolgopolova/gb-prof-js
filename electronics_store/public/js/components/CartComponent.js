const cart_item = {
    ...
    <div>
        ...
        <button class="cart__info_block__card__btn" @click="$root.$refs.cart.removeProduct(cartProduct)" >&#10006;</button>
    </div>
    `
};
...
const cart = {
    ...
    template: `
    <div>
        <button class="header__botton_cart" type="button" @click="isVisibleCart = !isVisibleCart">
            <svg width="24" height="auto" viewBox="0 0 32 29" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="cart__info_block" v-show="isVisibleCart">
            ...
            <cart_item class="cart__info_block__card" v-for="product of cartProducts" :key="product.id_product" :cart-product="product">
            </cart_item>
        </div>
    </div>
    `
